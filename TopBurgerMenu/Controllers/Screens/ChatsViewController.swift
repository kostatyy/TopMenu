...
class ChatsViewController: UIViewController, BaseViewControllerProtocol {

    private var topMenu: TopMenuView!
    private var contentView: ContentView!
    private var sectionTitle: ScreentTitle = .Chats
    ...
    override func viewDidLoad() {
        ...
        customizeViewController(navTitle: "Chats")
    ...
    private func setupContent() {
        ...
        contentView = ContentView(frame: view.frame, bgColor: .chatsBgColor)
